class Question {
  ...
  tMessage () {
    ...
    if(
        this.input1.value() !== "Enter Your Name Here...." && this.input1.value () !== '' && 
        this.input2.value () !== "Enter Correct Option No.." && this.input2.value () !== ''
      ) {
          console.log (`Input1 value: --  ${this.input1.value ()}  -- Input2: --${this.input2.value ()}--`);
      ...
      if (
        ...
        this.fMsgs [0].show ();
      } else if (this.input1.value () === "Enter Your Name Here...." || this.input1.value () === '') {
        this.fMsgs [1].html ("Please Enter Your Name");
        this.fMsgs [1].position (300, 300);
        this.fMsgs [1].show ();
      } else if (this.input2.value () === "Enter Correct Option No.." ||this.input2.value () === '') {
